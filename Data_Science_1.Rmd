...
p_side_by_side
```
This is a rough look at our data for per capita income after we removed the outliers, we can see the distributuon for this data is roughly normally distributed. 
