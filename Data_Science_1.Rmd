...
ggplot(data_counties_filtered, 
  ...
  labs(
    title = "Per Capita Personal Income Distribution by Selected States (2020)",
    subtitle = "Balanced sample across low, medium, and high income states",
    x = "State",
...
To determine the extreme values to smoothen the distribution of income, we exclude value that is more than 5 standard deviation away.
