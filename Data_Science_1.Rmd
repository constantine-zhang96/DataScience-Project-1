...
upperL2020 <- mean(data_counties$per_capita_personal_income_2020) + 5*sd(data_counties$per_capita_personal_income_2020)

upperLBachelor2020 <- mean(data_counties$bachelor_degree_numbers_2016_2020) + 5*sd(data_counties$bachelor_degree_numbers_2016_2020)

upperLAssociate2020<- mean(data_counties$associate_degree_numbers_2016_2020) + 5*sd(data_counties$associate_degree_numbers_2016_2020)
```
...
ggplot(data_counties, aes(x = bachelor_degree_numbers_2016_2020, y = per_capita_personal_income_2020 )) +
  ...
  scale_x_continuous(limits = c(0, upperLBachelor2020)) +
  scale_y_continuous(limits = c(0, upperL))
...
ggplot(data_counties, aes(x = associate_degree_numbers_2016_2020 , y = per_capita_personal_income_2020 )) +
  ...
  scale_x_continuous(limits = c(0, upperLAssociate2020)) +
  scale_y_continuous(limits = c(0, upperL2020))
